...
// MessageText:
//
// The WS-Management service cannot process the operation. Virtual account feature is not available in Windows 7, Server 2008 R2 and other downlevel platforms.
//
