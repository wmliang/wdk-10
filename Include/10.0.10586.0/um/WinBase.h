...
FormatMessageA(
    ...
    _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) != 0, _Out_writes_bytes_(sizeof(LPSTR)))
...
FormatMessageW(
    ...
    _In_     DWORD dwMessageId,
    _In_     DWORD dwLanguageId,
    _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) != 0, _Out_writes_bytes_(sizeof(LPWSTR)))
    _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) == 0, _Out_writes_z_(nSize))
             LPWSTR lpBuffer,
    _In_     DWORD nSize,
    _In_opt_ va_list *Arguments
