...
#define JET_paramMaxValueInvalid				195 //	This is not a valid parameter. It can change from release to release!
...
#define JET_errColumnCannotBeEncrypted				-1439	//	Only JET_coltypLongText and JET_coltypLongBinary columns can be encrypted
