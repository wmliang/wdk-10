...
typedef enum CLCTL_CODES {
    ...
    CLCTL_NOTIFY_S2D_POOL_CHANGE                  = CLCTL_EXTERNAL_CODE( 2905, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY ),
#endif
...
typedef struct _NOTIFY_S2D_POOL_CHANGE_IN
{
    ...
    //
    // The change notification type, one of the NOTIFY_S2D_POOL_CHANGE_IN_CHANGE_TYPE_* operations above.
    //
    UINT64  ChangeType;

    //
    // Parameters valid when ChangeType == NOTIFY_S2D_POOL_CHANGE_IN_CHANGE_TYPE_POOL_DRIVE_CHANGED
    //
    struct
    {
        //
