...
//      - DeviceDsmAction_GetByteAddressRanges: STORAGE_DSM_GET_BYTE_ADDRESS_RANGES
//
...
typedef DWORD DEVICE_DATA_MANAGEMENT_SET_ACTION;
    ...
    #define DeviceDsmAction_GetByteAddressRanges    (17 | DeviceDsmActionFlag_NonDestructive)
...
//
// DSM output structure for DeviceDsmAction_GetByteAddressRanges
//
...
typedef struct _STORAGE_DSM_GET_BYTE_ADDRESS_RANGES {
    ...
    _Field_range_(==, sizeof(struct _STORAGE_DSM_GET_BYTE_ADDRESS_RANGES))
    DWORD                        Size;                      // The size of this structure in bytes.

    DWORD                        Reserved;                  // Reserved for future use.

    DWORD                        NumberOfRanges;            // Number of entries in Ranges
    DEVICE_STORAGE_ADDRESS_RANGE Ranges[ANYSIZE_ARRAY];

} STORAGE_DSM_GET_BYTE_ADDRESS_RANGES, *PSTORAGE_DSM_GET_BYTE_ADDRESS_RANGES;
