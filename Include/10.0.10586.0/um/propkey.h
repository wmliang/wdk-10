...
//  Name:     System.Devices.AepService.Bluetooth.GattService.CacheMode -- PKEY_Devices_AepService_Bluetooth_GattService_CacheMode
//  Type:     UInt16 -- VT_UI2
//  FormatID: {9744311E-7951-4B2E-B6F0-ECB293CAC119}, 5
//
//  Sets the Bluetooth Gatt cache mode for the query.
DEFINE_PROPERTYKEY(PKEY_Devices_AepService_Bluetooth_GattService_CacheMode, 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19, 5);
#define INIT_PKEY_Devices_AepService_Bluetooth_GattService_CacheMode { { 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19 }, 5 }

//  Name:     System.Devices.AepService.Bluetooth.GattService.Device -- PKEY_Devices_AepService_Bluetooth_GattService_Device
//  Type:     UInt64 -- VT_UI8
//  FormatID: {9744311E-7951-4B2E-B6F0-ECB293CAC119}, 6
//
//  Sets the Bluetooth device address to query.
DEFINE_PROPERTYKEY(PKEY_Devices_AepService_Bluetooth_GattService_Device, 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19, 6);
#define INIT_PKEY_Devices_AepService_Bluetooth_GattService_Device { { 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19 }, 6 }

//  Name:     System.Devices.AepService.Bluetooth.RfcommService.CacheMode -- PKEY_Devices_AepService_Bluetooth_RfcommService_CacheMode
//  Type:     UInt16 -- VT_UI2
//  FormatID: {9744311E-7951-4B2E-B6F0-ECB293CAC119}, 7
//
//  Sets the Bluetooth RFCOMM cache mode for the query.
DEFINE_PROPERTYKEY(PKEY_Devices_AepService_Bluetooth_RfcommService_CacheMode, 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19, 7);
#define INIT_PKEY_Devices_AepService_Bluetooth_RfcommService_CacheMode { { 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19 }, 7 }

//  Name:     System.Devices.AepService.Bluetooth.RfcommService.Device -- PKEY_Devices_AepService_Bluetooth_RfcommService_Device
//  Type:     UInt64 -- VT_UI8
//  FormatID: {9744311E-7951-4B2E-B6F0-ECB293CAC119}, 8
//
//  Sets the Bluetooth device address to query.
DEFINE_PROPERTYKEY(PKEY_Devices_AepService_Bluetooth_RfcommService_Device, 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19, 8);
#define INIT_PKEY_Devices_AepService_Bluetooth_RfcommService_Device { { 0x9744311E, 0x7951, 0x4B2E, 0xB6, 0xF0, 0xEC, 0xB2, 0x93, 0xCA, 0xC1, 0x19 }, 8 }
